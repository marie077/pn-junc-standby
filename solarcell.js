...
var container2, camera, scene, renderer;
var voltageLevel;
var cameraControls;
var gui;
...
//boltzmann distribution letiables
var scalar = 0.5;
...
//recombination letiables
var minDistance = 30;
var recombinationOccured = false;
var e_sphere_outside_depletion_range = false;
var h_sphere_outside_depletion_range = false;
var recombination_orbs = [];


//VR control letiables
...
var solarCell;
var trapezoid_top = 20;
var trapezoid_bottom = 60;
var trapezoid_height = cubeSize.y;
var solarPosition = new THREE.Vector3(0,0,0);
...
setInterval(() => {
    let generatedPair = Generation.solarGeneratePair(solarCell, trapezoid_height, trapezoid_top, cubeSize);
